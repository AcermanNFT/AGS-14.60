...
int InitImGui()
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"Andreu", nullptr };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Andreu 14.60", (WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX), 100, 100, 640, 480, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!done)
    {
        ...
        if (ImGui::BeginTabBar("tab_settings"))
        {
            ...
            {
                ImGui::Checkbox("Enable LateGame", &bLategame);
                ImGui::Checkbox("Enable Vehicles", &bEnableVehicles);
            }
        }
